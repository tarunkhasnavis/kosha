...
import { Sheet, SheetContent, SheetTitle, Button, Input, Label, Textarea, Checkbox, Badge, Switch, DatePicker, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@kosha/ui"
...
import type { Order, Product, Customer } from "@kosha/types"
    ...
    <Sheet open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <SheetContent
        ...
        className={cn(
          ...
          "w-full",
          mode === "peek" ? "md:w-[66vw]" : "md:w-screen"
        )}
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200/60 shrink-0 bg-white">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Fullscreen toggle - hidden on mobile where panel is always full width */}
            <Button
              variant="ghost"
              size="icon"
