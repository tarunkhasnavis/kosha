    ...
    <>
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between md:gap-4 mb-6">
        ...
        <Button
          ...
          className="h-10 px-4 rounded-2xl bg-slate-900 hover:bg-slate-800 text-slate-100 text-sm font-medium shadow-sm gap-0 leading-none self-start"
        >
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="hidden lg:table-cell text-right">Total Spend</TableHead>
